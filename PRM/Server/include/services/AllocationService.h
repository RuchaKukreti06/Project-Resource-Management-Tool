...
class AllocationService
{
   public:
    ...
    bool createAllocation(const Allocation& allocation, int createdByUserId, std::string& message);
    bool endAllocation(int allocationId, const std::string& endDate, std::string& message);
    std::vector<Allocation> getProjectAllocations(int projectId);
    bool recomputeEmployeeStatus(int employeeId, const std::string& todayDate);
